...
const IndexPage: React.FC<PageProps> = () => {
  ...
  return (
    <>
      <Layout>
        <div className="container-small container-content">
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The Darkroomm.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to The Darkroomm, accessible from <a href="thedarkroomm.com" rel="external nofollow noopener" target="_blank">thedarkroomm.com</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: thdarkroommfactorypresets@gmail.com</li>
            </ul>
          </div>
      </Layout>
    </>
